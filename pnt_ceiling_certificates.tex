...
log-audit summaries, and this note --- is deposited on Zenodo as a citable
archive: concept DOI
\href{https://doi.org/10.5281/zenodo.21221207}{10.5281/zenodo.21221207}
(cites all versions) and this-version DOI
\href{https://doi.org/10.5281/zenodo.21221208}{10.5281/zenodo.21221208}
(release tag \texttt{v1.1}), with the development history at
\url{https://github.com/techno-optimist/pnt-ceiling-certificates}. The Zenodo
version record \emph{is} the pinned archive: it carries a per-file MD5 checksum
for every deposited file, so no self-referential commit hash is embedded here.
The two dual SHA-256 hashes tabulated above additionally pin the load-bearing
